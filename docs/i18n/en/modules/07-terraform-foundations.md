...
- Azure ML lifecycle context: [Module 02](02-azure-ml-overview.md)
...
| **State** | A file that records which cloud resources Terraform currently manages. |
...
| **Backend** | Where the state file is stored (local file or shared cloud storage). |
...
## Advanced Team Concepts (Optional)

These concepts are useful later for team collaboration and production systems:

- Remote state in shared storage
- State locking for concurrent changes
- Multi-environment workflows (dev, test, prod)
- Reusable Terraform modules

If you are new to ML engineering, you can continue to Module 08 after mastering the four core commands.

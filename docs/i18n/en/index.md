...
- ML work is a lifecycle, not only model training.
- Deployment and monitoring are part of the model's real work.
...
<div class="home-grid">
	...
	<a class="home-card" href="modules/09-wrap-up-and-next-steps/">
